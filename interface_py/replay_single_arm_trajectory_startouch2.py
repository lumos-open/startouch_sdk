...
def main():
    ...
    parser.add_argument('--left_file', type=str, default='/home/zgy/FastUMI_Touch_test/data_trajectory/session_091619/right_hand_250801DR48FP26001130/Merged_Trajectory/merged_trajectory.txt')
